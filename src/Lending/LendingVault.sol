...
/* 
    ...
    @notice This contract is used to lend coins to users, it allows users to deposit erc-20 coins, borrow coins, withdraw coins and return borrowed coins controlled by lending manager.
